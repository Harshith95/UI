  ...
  return (
    <AppBar position="fixed" sx={{ width: '200px', height: '100vh', left: 0, top: 0, }}>
      <Toolbar sx={{ flexDirection: 'column', alignItems: 'flex-start', p: 2 }}>
        ...
        <Button component={Link} to="/users/update" color="inherit" sx={{ justifyContent: 'flex-start', width: '100%', textAlign: 'left' }}>
          Update User
        </Button>
        <Button component={Link} to="/users/list" color="inherit" sx={{ justifyContent: 'flex-start', width: '100%', textAlign: 'left' }}>
          Users
        </Button>
        {
          user && (
